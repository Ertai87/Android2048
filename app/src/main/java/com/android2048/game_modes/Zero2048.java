...
public class Zero2048 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            engine = new Engine<>(ArrayModel.class, 4, 4, Constants2048.CLEAR_VALUE_ZERO, Constants2048.WIN_VALUE, new Comparator<Integer>() {
                @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case R.id.newgame:
                ...
                return true;
            case R.id.main:
                Intent myIntent = new Intent(Zero2048.this, Loader2048.class);
                Zero2048.this.startActivity(myIntent);
            default:
    ...
    void updateBoard(){
        for (int i=0; i < 4; i++){
            for (int j=0; j < 4; j++){
                ...
                if (engine.getBoardModel().get(i, j).equals(Constants2048.CLEAR_VALUE_ZERO)){
